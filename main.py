...
def getLetterGrade(grade1, grade2, grade3):
...
def run():
  ...
  credit1 = int(credit1)
  print("Grade point for course 1 is: " + getLetterGrade(grade1))
  grade2 = input("Enter your course 2 letter grade: ")
  credit2 = input("Enter your course 2 credit: ")
  credit2 = int(credit2)
  print("Grade point for course 2 is: " + getLetterGrade(grade2))
  grade3 = input("Enter your course 3 letter grade: ")
  credit3 = input("Enter your course 3 credit: ")
  credit3 = int(credit3)
  print("Grade point for course 3 is: " + getLetterGrade(grade3))
